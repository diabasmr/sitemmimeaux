    ...
    <main class="reservation-container mt-5 mb-5 mt-md-auto">
        <form action="../PHPpure/reservation_salle.php" method="post" class="ms-4 ms-md-auto my-5 mt-md-auto">
            ...
            <div class="salle-selector">
                ...
                <button type="button" data-salle="2">Salle 212</button>
            </div>
            ...
            <section class="reservation-content">
                ...
                <div class="equipment">
                    ...
                    <?php
                    $idS = $_GET['idS'];
                    $sql4 = "SELECT TIME(date_debut) as heure_debut, DATE(date_debut) as date_debut, TIME(date_fin) as heure_fin, DATE(date_fin) as date_fin FROM reservations r JOIN concerne_salle c ON r.idR = c.idR WHERE idS = ? AND valide <= 1;";
