...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['submit'])) {
        ...
        $sql = "UPDATE materiel SET photo = :img, designation = :designation, quantité = :quantite, descriptif = :descriptif, typeM = :type, etat = :etat, lien_demo = :lien_demo  WHERE idM = :idM";
        $stmt = $pdo->prepare($sql);
        $stmt->execute([
            ':img' => $photo,
